...
export async function POST(req: Request, res: Response) {
  ...
  try {
    ...
    const response = await openai.images.generate({
      ...
      **Generate a unique, minimalistic logo as an SVG/PNG with a transparent background. The logo should represent simplicity and elegance, suitable for modern brands. Focus on abstract shapes and clean lines. Ensure each logo is distinct and memorable**
      -------
      ...
      1. Side-by-Side Logo and Name:
        ...
        - Place the logo name directly next to the logo icon, aligned vertically with the center of the logo.
